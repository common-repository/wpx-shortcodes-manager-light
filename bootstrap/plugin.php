...
if (class_exists('\WPXShortcodesManagerLight\WPBones\Foundation\Plugin')) {
  $plugin = new \WPXShortcodesManagerLight\WPBones\Foundation\Plugin(realpath(__DIR__ . '/../'));
   ...
   */
  do_action('wpx-shortcodes-manager-light_loaded');
