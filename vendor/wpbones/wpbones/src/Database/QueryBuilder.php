...
namespace WPXShortcodesManagerLight\WPBones\Database;

use InvalidArgumentException;
use WPXShortcodesManagerLight\WPBones\Database\Support\Collection;
use WPXShortcodesManagerLight\WPBones\Database\Support\Model;
...
class QueryBuilder
{
   ...
   *
   * @var \WPXShortcodesManagerLight\WPBones\Database\Support\Collection
   */
  private $collection = [];
  ...
  */
   ...
   * @return \WPXShortcodesManagerLight\WPBones\Database\QueryBuilder
   */
