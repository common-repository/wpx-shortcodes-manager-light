...
namespace WPXShortcodesManagerLight\WPBones\View;
  ...
  public function render($asHTML = false)
  {
    ...
    // Use a php file
      ...
      $func = function () {
        ...
        if (!class_exists('WPXShortcodesManagerLight\Html')) {
          class_alias('\WPXShortcodesManagerLight\WPBones\Html\Html', 'WPXShortcodesManagerLight\Html', true);
        }
